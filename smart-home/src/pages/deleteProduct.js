...
const DeleteProduct = () => {
    ...
    const deleteProduct = () => {
        if (window.confirm('Are you sure you want to delete the product?')) {
            firebase.database().ref().child('Products').child(state.pushId).remove()
            ...
            <Row>
                ...
                <Col md={8} className="">
                    <Row style={{ marginTop: "45px" }}>
                        <h5 style={{ borderBottom: "3px solid black", marginBottom: "20px", fontWeight: "700", fontSize: "20px" }}>Delete Product</h5>
                        <Form>
                        <Row className='mt-2'>
                            ...
                            <Row className='mt-2'>
                                <Col sm={3}></Col>
                                <Col sm={5}>
                                    <Button onClick={deleteProduct} color="danger">Delete</Button><br />
                                </Col>
                            </Row>
                        </Form>
                    </Row>
